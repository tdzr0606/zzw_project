...
layui.define(['laytpl', 'laypage', 'layer', 'form'], function(exports){
        ...
        that.eachCols(function(i3, item3){
          ...
          var td = ['<td data-field="'+ (item3.field||i3) +'"'+ function(){
            ...
            ,'<div class="layui-table-cell laytable-cell-'+ function(){
              ...
              if(item3.checkbox){
                return '<input type="checkbox" name="layTableCheckbox" lay-skin="primary" id="tableCheckBox'+i1+'" '+ function(){
  ...
  /*table.selectArray = function(id,selectIndex){
      ...
      layui.each(data, function(i, item)
      {
        ...
        console.log(i);
          console.log(item);
          table.clearCacheKey(item)
          item.LAY_CHECKED = true;
          item.checked = true;
          layui.event.call(this, 'table', 'checkbox(' + id + ')', {
              checked: true
              , data:item
              , type: 'all'
          });
  ...
  /*table.selectArray=function(selectIndex)
  {
      var nums = 0
          ,arr = []
          ,data = table.cache[id];
      var selectIndex=new Array[1,2];
      layui.each(data, function(i, item){
          if(item[table.config.checkName]){
              nums++;
              arr.push(table.clearCacheKey(item));
